...
from xgmdn_utils.model.mavi import xGDN
...
CFG = {
    ...
    "early_stopping": {"patience": 100, "monitor": "val_loss", "min_delta": 1e-4},
    "model_args": {"input_dim": 176, "hidden_dims": [50, 25]},
